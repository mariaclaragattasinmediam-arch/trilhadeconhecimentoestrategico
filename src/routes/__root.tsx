  ...
  head: () => ({
    meta: [
      ...
      { title: "Trilha de Conhecimento Estratégico – Ongoing" },
      {
        name: "description",
        content:
          "Plataforma corporativa de treinamento da Ongoing: cursos, módulos, aulas e acompanhamento de progresso.",
      },
      { property: "og:title", content: "Trilha de Conhecimento Estratégico – Ongoing" },
      {
        property: "og:description",
        content: "Plataforma corporativa de treinamento com trilhas, aulas e progresso individual.",
      },
