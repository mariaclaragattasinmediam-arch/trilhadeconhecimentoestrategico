...
export const Route = createFileRoute("/_authenticated/admin/usuarios")({
  head: () => ({
    meta: [
      { title: "Admin · usuarios — Trilha Ongoing" },
      { name: "description", content: "Área administrativa da Trilha de Conhecimento Ongoing." },
      { property: "og:title", content: "Admin · usuarios — Trilha Ongoing" },
      { property: "og:description", content: "Área administrativa da Trilha Ongoing." },
    ],
  }),
  component: () => (
    <>
      <PageHeader title="usuarios" description="Gerenciamento administrativo." />
